...
public class ShopCatalogInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        List<ShopSeedItem> seedItems = List.of(
                ...
                new ShopSeedItem("동그란 안경", "FACE", "/assets/shop_accessory_glasses.svg", 140),
                new ShopSeedItem("윙슈트", "CLOTHES", "/assets/shop_wingsuit.svg", 300),
                new ShopSeedItem("아톰 신발", "FOOT", "/assets/shop_atomshoes.svg", 200),
                new ShopSeedItem("창", "HAND", "/assets/shop_spear.svg", 250),
                new ShopSeedItem("손 노트북", "HAND", "/assets/shop_accessory_notebook.svg", 160),
                new ShopSeedItem("상처", "FACE", "/assets/shop_hurt.svg", 50),
                new ShopSeedItem("트로피", "HAND", "/assets/shop_trophy.svg", 180)
        );
